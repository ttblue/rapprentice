...
def plot_lines_and_points(p1, p2, p3, lines, color=(1,1,1), line_width=1, opacity=0.4):
    """
    input  :
    ...
    mlab.points3d(p1[:,0].tolist(), p1[:,1].tolist(), p1[:,2].tolist(), color=(1,0,0), scale_factor=0.005)
    mlab.points3d(p2[:,0].tolist(), p2[:,1].tolist(), p2[:,2].tolist(), color=(0,0,1), scale_factor=0.005)
    mlab.points3d(p3[:,0].tolist(), p3[:,1].tolist(), p3[:,2].tolist(), color=(0,1,0), scale_factor=0.005)
